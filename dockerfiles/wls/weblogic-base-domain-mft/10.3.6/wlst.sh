...
WL_HOME="/u01/oracle/weblogic/wlserver_10.3"
...
JVM_ARGS="-Dprod.props.file='${WL_HOME}'/.product.properties -Djava.security.egd=file:/dev/./urandom ${WLST_PROPERTIES} ${JVM_D64} ${MEM_ARGS} ${CONFIG_JVM_ARGS}"
